...
if __name__ == "__main__":
    ...
    os.makedirs('outputs/penguin', exist_ok=True)
    os.makedirs('outputs/penguin/raw_outputs', exist_ok=True)
    os.makedirs('outputs/penguin/decoded_text', exist_ok=True)
    ...
    for i in range(args.start, args.end):
        ...
        # Save raw outputs
        torch.save(outputs, f'outputs/penguin/raw_outputs/output_{i}_temp{temp_str}.pt')
