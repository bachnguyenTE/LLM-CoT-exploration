...
for ((i=0; i<num_subdivisions; i++)); do
    ...
    python "$SCRIPT_DIR/unthink_penguin_generator.py" --start $subdivision_start --end $subdivision_end --temperature $temperature --model_name "$model_name" --output_folder "$output_folder" &
