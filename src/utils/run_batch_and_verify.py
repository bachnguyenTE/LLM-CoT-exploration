...
def main():
    ...
    if not args.skip_extraction:
        ...
        success = run_command(cmd, "Extracting Activations")
        if not success:
    ...
    if not args.skip_verification:
        ...
        success = run_command(verify_cmd, "Verifying Activation Files")
        if not success:
    ...
    if args.visualize:
        ...
        for file_idx, file_path in enumerate(activation_files):
            ...
            if args.viz_modes in ["pca", "all"]:
                ...
                run_command(pca_cmd, f"Visualizing PCA: File {file_id}")
            ...
            if args.viz_modes in ["logits", "all"]:
                ...
                run_command(logits_cmd, f"Showing Token Predictions: File {file_id}")
